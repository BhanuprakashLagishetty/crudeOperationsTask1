...
<table>
    ...
    <div style="display:flex">
        ...
        <%
            List<TrainModel> trainList = (List<TrainModel>) request.getAttribute("Train");
            if (trainList != null) {
        ...
        <tr>
            ...
            <td>
              ...
              <form action="DisplayadminTrainTickets" style="margin-right:5px;">
                     <input type="hidden" name="trainId" value= <%= Train.getId() %>>
                     <input type="submit" value="Add Tickets" class="btn-edit">
              </form>
            </td>
            <td>
             <form action="DisplayIntermediateStations" style="margin-right:5px;">
                <input type="hidden" name="trainId" value= <%= Train.getId() %>>
                 <input type="submit" value="Add Stops" class="btn-edit">
             </form>

            </td>
               <td>
                   <form action="removeTrain" style="margin-right:5px;">
                   <input type="hidden" name="trainId" value= <%= Train.getId() %>>
                   <input type="submit" value="deleteTrain" class="btn-edit">
                   </form>
